import svgPaths from "./svg-ws5oyjj65r";
...
function PriceRow() {
  return (
    <div className="content-stretch flex gap-[6px] items-end leading-[normal] overflow-clip relative shrink-0 whitespace-nowrap" data-name="Price Row">
      <p className="font-['Lora:Bold',sans-serif] font-bold relative shrink-0 text-[#5c3e1e] text-[32px]">Rp400.000</p>
      <p className="font-['Outfit:Regular',sans-serif] font-normal relative shrink-0 text-[#9e8e78] text-[13px]">/ tahun</p>
    </div>
  );
}
...
function SavingsPill() {
  return (
    <div className="bg-[#f3faf7] relative rounded-[100px] shrink-0" data-name="Savings Pill">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[9px] py-[4px] relative rounded-[inherit]">
        <p className="font-['Outfit:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#0e9f6e] text-[11px] whitespace-nowrap">Hemat Rp20.000+ per tahun</p>
      </div>
...
function PriceDisplayTahunan() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start overflow-clip pb-[4px] pt-[10px] relative shrink-0 w-[280px]" data-name="Price Display / Tahunan">
      <p className="font-['Outfit:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#9e8e78] text-[11px] tracking-[0.2px] whitespace-nowrap">Bayar tahunan</p>
      <PriceRow />
      <SavingsRow />
    </div>
  );
