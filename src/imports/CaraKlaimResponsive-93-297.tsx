import svgPaths from "./svg-8v3kplsup3";
...
function NavItem() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-center min-h-px min-w-px relative rounded-[6px] self-stretch" data-name="nav-item">
      <p className="font-['Outfit:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#6b7280] text-[14px] whitespace-nowrap">Keanggotaan</p>
    </div>
  );
}
...
function Active() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0 w-full" data-name="active">
      <p className="font-['Outfit:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#876747] text-[14px] text-center whitespace-nowrap">Darurat</p>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Header">
      ...
      <p className="font-['Lora:Bold',sans-serif] font-bold leading-[0] min-w-full relative shrink-0 text-[#1a1a1a] text-[0px] w-[min-content]">
        ...
        <span className="leading-[1.4] text-[24px]">untuk non-anggota</span>
      </p>
    </div>
  );
}
...
function TextContent() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[6px] items-start min-h-px min-w-px overflow-clip relative" data-name="Text Content">
      <p className="font-['Outfit:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#1a1a1a] text-[16px] w-full">Klik ‘Pesan Layanan Darurat’</p>
      <p className="font-['Outfit:Regular',sans-serif] font-normal leading-[19px] relative shrink-0 text-[#8c8c8c] text-[13px] w-full">Informasikan ada anggota keluarga yang tutup usia.</p>
    </div>
  );
}
...
function TextContent2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[6px] items-start min-h-px min-w-px overflow-clip relative" data-name="Text Content">
      <p className="font-['Outfit:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#1a1a1a] text-[16px] w-full">Selesaikan pembayaran</p>
      <p className="font-['Outfit:Regular',sans-serif] font-normal leading-[19px] relative shrink-0 text-[#8c8c8c] text-[13px] w-full">Bayar sesuai harga layanan yang dibutuhkan.</p>
    </div>
  );
}
...
function TextContent3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[6px] items-start min-h-px min-w-px overflow-clip relative" data-name="Text Content">
      ...
      <p className="font-['Outfit:Regular',sans-serif] font-normal leading-[19px] relative shrink-0 text-[#8c8c8c] text-[13px] w-full">Tim Pulang akan mengundang keluargamu ke grup WhatsApp untuk koordinasi teknis layanan.</p>
    </div>
  );
}
...
function StepNumber4() {
  return (
    <div className="bg-[#1a1a1a] relative rounded-[22px] shrink-0 size-[44px]" data-name="Step Number">
      <div className="content-stretch flex items-center justify-center overflow-clip relative rounded-[inherit] size-full">
        <p className="font-['Outfit:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[18px] text-white whitespace-nowrap">5</p>
      </div>
      <div aria-hidden="true" className="absolute border-3 border-[#f0e8db] border-solid inset-[-3px] pointer-events-none rounded-[25px]" />
    </div>
  );
...
function Step4() {
  return (
    <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="Step 5">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[16px] items-start p-[20px] relative size-full">
          <StepNumber4 />
          <TextContent4 />
