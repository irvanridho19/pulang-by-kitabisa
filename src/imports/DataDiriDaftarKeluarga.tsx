import svgPaths from "./svg-q13vvtzbsm";
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <p className="font-['Outfit:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#4b5563] text-[18px] w-full">Sekarang, lengkapi data keluargamu</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px relative" data-name="Content">
      <div className="flex flex-[1_0_0] flex-col font-['Outfit:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px relative text-[#6b7280] text-[14px]">
        <p className="leading-[1.5]">Masukkan nama keluargamu</p>
      </div>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <p className="font-['Outfit:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#111928] text-[16px] w-full">Data Dirimu (Sebagai Pengelola Akun)</p>
    </div>
  );
}
...
function Content3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px relative" data-name="Content">
      <div className="flex flex-[1_0_0] flex-col font-['Outfit:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px relative text-[#6b7280] text-[14px]">
        <p className="leading-[1.5]">Masukkan nama lengkapmu</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Input Field">
        <p className="font-['Outfit:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#111928] text-[14px] w-full">Nama Lengkapmu</p>
        <Input3 />
      </div>
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Input Field">
        <p className="font-['Outfit:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#111928] text-[14px] w-full">Nomor WhatsApp-mu</p>
        <Input4 />
      </div>
    </div>
  );
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full">
      <Frame1 />
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Input Field">
        <p className="font-['Outfit:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#111928] text-[14px] w-full">Nama Lengkap Keluarga sesuai KTP</p>
        <Input />
      </div>
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Input Field">
        <p className="font-['Outfit:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#111928] text-[14px] w-full">Hubungan denganmu</p>
        <Input1 />
      </div>
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Input Field">
        <p className="font-['Outfit:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#111928] text-[14px] w-full">Nomor WhatsApp Keluargamu</p>
        <Input2 />
      </div>
      <Frame4 />
...
export default function DataDiriDaftarKeluarga() {
  return (
    <div className="bg-white relative size-full" data-name="Data Diri - Daftar Keluarga">
      <Header />
      <StepperNavigation />
      <Frame6 />
      <Frame />
